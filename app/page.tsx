...
const greeting = () => { const h = new Date().getHours(); if (h < 12) return "Доброе утро"; if (h < 18) return "Добрый день"; return "Добрый вечер"; };
      ...
      <div className={anim("animate-fade-up", 2)}>
        {mitTask ? (
          ...
          <div className="bg-white dark:bg-ios-card-dark rounded-2xl p-4 shadow-sm border border-ios-separator/30 animate-scale-in">
            <p className="text-sm font-medium mb-2">Выберите MIT:</p>
        ...
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/50 backdrop-blur-sm p-0 md:p-4 animate-fade-in">
          <div className="bg-white dark:bg-ios-card-dark w-full max-w-md rounded-t-3xl md:rounded-3xl p-6 animate-slide-up">
            ...
            <form onSubmit={addMeeting} className="space-y-4">
              ...
              <button type="submit" className="w-full bg-black dark:bg-white text-white dark:text-black py-3.5 rounded-xl text-base font-medium active:scale-[0.98] transition-transform">Добавить</button>
            </form>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/50 backdrop-blur-sm p-0 md:p-4 animate-fade-in">
          <div className="bg-white dark:bg-ios-card-dark w-full max-w-md rounded-t-3xl md:rounded-3xl p-6 animate-slide-up">
            ...
            <form onSubmit={addHabit} className="space-y-4">
              ...
              <button type="submit" className="w-full bg-black dark:bg-white text-white dark:text-black py-3.5 rounded-xl text-base font-medium active:scale-[0.98] transition-transform">Создать</button>
            </form>
          </div>
        </div>
      )}
